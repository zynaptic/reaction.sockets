...
import com.zynaptic.reaction.sockets.test.core.LocalSSLClientServerLoopback;
 ...
 */
public class LocalSSLClientServerLoopbackTest extends TestCase {
  private static final String TEST_PROTOCOL = "TLSv1.3";
  ...
  public void testLocalClientServerLoopback() {
    ...
    try {
      ...
      testStatus = new LocalSSLClientServerLoopback().runTest(reactor, logLevel, TEST_PROTOCOL).defer();
      reactorControl.stop();
      reactorControl.join();
